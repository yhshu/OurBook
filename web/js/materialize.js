...
Vel = jQuery ? jQuery.Velocity : $ ? $.Velocity : Velocity, function (a) {
    a.fn.collapsible = function (b, c) {
        ...
        return b = a.extend(d, b), this.each(function () {
            ...
            var l = a(this), m = a(this).find("> li > .collapsible-header"), n = l.data("collapsible");
    ...
    var b = {
        init: function (b) {
            ...
            return this.each(function (c) {
                var e, f, g, h, i, j = d + c, k = a(this), l = a(window).width(), m = k.find("li.tab a"), n = k.width(),
                    o = a(), p = Math.max(n, k[0].scrollWidth) / m.length, q = prev_index = 0, r = !1, s = 300,
                    t = function (a) {
                        ...
                        q - a >= 0 ? (h.velocity({right: t(e)}, {
                            ...
                            queue: !1,
                            easing: "easeOutQuad"
                        }), h.velocity({right: t(e)}, {duration: s, queue: !1, easing: "easeOutQuad", delay: 90}))
                    };
    ...
    a(document).ready(function () {
        ...
        a(document).on("change", g, function (b) {
            ...
            if (!h) {
                var b = a(this).children(".thumb"), c = parseInt(a(this).css("padding-left")), d = 7 + c + "px";
